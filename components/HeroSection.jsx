...
export default function HeroSection() {
  ...
  return (
    <section id="hero" className="relative h-screen w-full overflow-hidden bg-page">
      ...
      {/* ------------------------------------------------------------------ */}
      <div className="relative z-10 h-full flex flex-col justify-end md:justify-center px-6 md:px-16 pb-28 md:pb-0">
        <div className="max-w-2xl">
          <span className="text-brand-400 font-semibold tracking-widest text-sm uppercase">
            {slide.kicker}
          </span>
          <h1 className="mt-3 text-3xl sm:text-4xl md:text-6xl font-extrabold leading-tight text-primary">
          ...
          <p className="mt-5 text-secondary text-base md:text-lg max-w-xl">{slide.sub}</p>
          <a
            href="#showcase"
      ...
      {/* ------------------------------------------------------------------ */}
      {/* فلش‌های ناوبری دستی (قبلی / بعدی) — شبیه سایت Sielaff، وسط دو طرف   */}
      {/* ------------------------------------------------------------------ */}
      <button
