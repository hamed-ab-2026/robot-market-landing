...
export default function HeroSection() {
    ...
    return (
        <section id="hero" className="relative h-screen w-full overflow-hidden bg-page">
            ...
            {/* ------------------------------------------------------------------ */}
            <div className="relative  z-10 h-full flex flex-col justify-end md:justify-end px-6 md:px-16 pb-28 md:pb-72">
                <div className="max-w-2xl">
                    ...
                    <div className="mt-8 flex flex-wrap gap-3">
                        <a
                            href="#showcase"
                            className="inline-flex items-center gap-2 bg-brand hover:bg-brand-400 text-ink-950 font-bold px-8 py-3.5 rounded-full transition-colors shadow-brandGlow"
                        >
                            {t.hero.cta}
                        </a>
                        <a
