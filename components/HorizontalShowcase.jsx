      ...
      >
        {quickViewMachine && (
          <div className="flex flex-col gap-4">
            <img src={quickViewMachine.image} alt={quickViewMachine.name} className="w-full h-64 object-contain" />
            ...
            <Button type="primary" size="large" icon={<ShoppingCartOutlined />} onClick={handleModalAddToCart}>
